...
const CSV_TEMPLATE_HEADERS = "name,code,capacity,venue_type,latitude,longitude,radius\n";
const CSV_TEMPLATE_ROW1 = "Main Auditorium,AUD,500,Written,9.076,7.398,50\n";
const CSV_TEMPLATE_ROW2 = "CBT Center A,CBT-A,150,CBT,9.077,7.399,50\n";

export function ImportVenuesModal({ isOpen, onClose }: ImportVenuesModalProps) {
  ...
  const handleImport = async () => {
    ...
    const result = await importVenues(parsedData);
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a CSV file with venue details to bulk-add them to the system.
          </DialogDescription>
        </DialogHeader>
